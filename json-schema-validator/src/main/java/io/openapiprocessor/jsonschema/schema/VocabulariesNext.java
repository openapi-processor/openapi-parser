...
public class VocabulariesNext {

    public static final Vocabulary applicator = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/applicator", getKeywordsApplicator ());
    public static final Vocabulary content = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/content", getKeywordsContent ());
    public static final Vocabulary core = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/core", getKeywordsCore ());
    public static final Vocabulary formatAnnotation = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/format-annotation", getKeywordsFormatAnnotation ());
    public static final Vocabulary formatAssertion = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/format-assertion", getKeywordsFormatAssertion ());
    public static final Vocabulary hyperSchema = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/hyper-schema", getKeywordsHyperSchema ());
    public static final Vocabulary metadata = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/meta-data", getKeywordsMetaData ());
    public static final Vocabulary unevaluated = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/unevaluated", getKeywordsUnevaluated ());
    public static final Vocabulary validation = new Vocabulary (
        "https://json-schema.org/draft/next/vocab/validation", getKeywordsValidation ());

    private VocabulariesNext() {}
