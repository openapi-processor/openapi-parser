    ...
    "item with deeply nested sub items"  {
        val msgs = listOf(
            ValidationMessage(
                schema, instance, "foo1", listOf(
                    ValidationMessage(
                        schema, instance, "foo2", listOf(
                            ValidationMessage(
                                schema, instance, "foo3", listOf(
                                    ValidationMessage(
                                        schema, instance, "foo4", listOf(
                                            ValidationMessage(
                                                schema, instance, "foo5", listOf(
                                                    ValidationMessage(
                                                        schema,
                                                        instance,
                                                        "foo6"
