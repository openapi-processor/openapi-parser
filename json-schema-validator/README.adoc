...
It implements the drafts *2020-12*, *2019-09*, *7*, *6* and *4*.

Vocabularies support is currently limited. Enabling/disabling vocabularies is not yet implemented except for *format-assertion*, *format-validation*.

It supports *annotations* and the output format: *verbose*.

It is tested against the official link:{json-schema-testsuite}[JSON Schema Test Suite]. It passes all required tests of the test suite & most *optional* tests.
