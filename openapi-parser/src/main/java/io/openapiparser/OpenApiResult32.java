...
import static io.openapiparser.OpenApiSchemas.OPENAPI_SCHEMA_32;
import static io.openapiparser.OpenApiSchemas.OPENAPI_SCHEMA_32_ID;
import static io.openapiprocessor.jsonschema.support.Null.nonNull;

public class OpenApiResult32 implements OpenApiResult {
    private static final Logger log = LoggerFactory.getLogger (OpenApiResult32.class);
    ...
    public OpenApiResult32(Context context, Bucket root, DocumentStore documents) {
    ...
    public boolean validate (Validator validator, SchemaStore schemaStore) {
        try {
            schemaStore.register (OPENAPI_SCHEMA_32_ID, OPENAPI_SCHEMA_32);
            JsonSchema schema = schemaStore.getSchema (OPENAPI_SCHEMA_32_ID, SchemaVersion.Draft202012);
